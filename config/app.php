        ...
        [
            ...
            '学生管理' => ['icon' => 'fa-users', 'perm' => 'student.*',
                'children' => [
                    ...
                    '学生组合' => ['url' => '/student/group', 'icon'=>'fa-edit', 'perm' => 'student.group'],
                ],
            ],
            ...
            '权限管理' => ['icon' => 'fa-unlock-alt', 'perm' => 'perm',
                'children' => [
                    '用户管理' => ['url' => '/auth/user', 'icon'=>'fa-user-secret', 'perm' => 'perm'],
                    '角色管理' => ['url' => '/auth/role', 'icon'=>'fa-smile-o', 'perm' => 'perm'],
                    '权限管理' => ['url' => '/auth/permission', 'icon'=>'fa-info', 'perm' => 'perm'],
                ],
            ],
        ],
    ],
