    ...
    var r = function(c, j) {
        ...
        return {
            ...
            onShow: function() {
                ...
                if (b && "img" == b.getName() && !b.data("cke-realelement") || b && "input" == b.getName() && "image" == b.getAttribute("type")) this.imageEditMode = b.getName(),
                this.imageElement = b;
            ...
            onOk: function() {
                ...
                j ? this.imageElement = c.document.createElement("img") : (this.imageElement = c.document.createElement("input"), this.imageElement.setAttribute("type", "image")),
                        ...
                        children: [{
                            ...
                            children: [{
                                ...
                                },
                                {
                                    ...
                                    validate: function() {
                                        var a = this.getValue().match(v); (a = !!(a && 0 !== parseInt(a[1], 
